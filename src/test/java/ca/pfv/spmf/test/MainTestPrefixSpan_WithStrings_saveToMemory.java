 ...
 */
public class MainTestPrefixSpan_WithStrings_saveToMemory extends MainTestBase {

	public static void main(String [] arg) throws IOException{    
		// Load a sequence database
		SequenceDatabase sequenceDatabase = new SequenceDatabase(); 
		sequenceDatabase.loadFile(new MainTestBase().fileToPath("contextPrefixSpanStrings.txt"));

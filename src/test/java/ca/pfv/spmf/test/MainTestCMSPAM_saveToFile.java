 ...
 */
public class MainTestCMSPAM_saveToFile extends MainTestBase {

	public static void main(String [] arg) throws IOException{    
		// Load a sequence database
		//String input = new MainTestBase().fileToPath("D1C20T20N0.5S6I5_SPMF.txt");
       String input = new MainTestBase().fileToPath("contextPrefixSpan.txt");

...
public class MainTestSequentialPatternMining4 {
	...
	public static void main(String [] arg) throws IOException{   
		String input = new MainTestBase().fileToPath("ContextMDSequenceNoTime.txt");
...
//		algoSeqDim2.setOutputSequenceIdentifiers(true);
		
		algoSeqDim2.runAlgorithm(contextMDDatabase, algo, algoDim, true, output);

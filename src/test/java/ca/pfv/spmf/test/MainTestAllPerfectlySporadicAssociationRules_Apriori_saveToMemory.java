 ...
 */
public class MainTestAllPerfectlySporadicAssociationRules_Apriori_saveToMemory extends MainTestBase {

	public static void main(String [] arg) throws IOException{
		// Loading the binary context
		String input = new MainTestBase().fileToPath("contextInverse.txt");

 ...
 */
public class MainTestCharm_bitset_saveToMemory extends MainTestBase {

	public static void main(String [] arg) throws IOException{

		// the database
		String input = new MainTestBase().fileToPath("contextPasquier99.txt");  
		...
		ItemsetsWithTIDSBitset itemsets = algo.runAlgorithm(null, database, minsup, true, 10000);

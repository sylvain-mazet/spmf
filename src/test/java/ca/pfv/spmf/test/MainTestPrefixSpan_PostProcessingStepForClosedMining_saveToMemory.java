 ...
 * @author agomariz
 */
public class MainTestPrefixSpan_PostProcessingStepForClosedMining_saveToMemory extends MainTestBase {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //sequenceDatabase.loadFile(new MainTestBase().fileToPath("contextCloSpan.txt"), support);
        //sequenceDatabase.loadFile(new MainTestBase().fileToPath("gazelle.txt"), support);

 ...
 * @author Ting Li
 */
public class MainTestEHAUPM_saveToFile extends MainTestBase {

	public static void main(String [] arg) throws Exception{
		
		String input = new MainTestBase().fileToPath("contextHAUIMiner.txt");
		String output = ".//output.txt";

		int min_utility = 24;  // 
		
		// Applying the HAUIMiner algorithm
		AlgoEHAUPM hauiminer = new AlgoEHAUPM();
	...
	public String fileToPath(String filename) throws UnsupportedEncodingException{
		URL url = MainTestEHAUPM_saveToFile.class.getResource(filename);

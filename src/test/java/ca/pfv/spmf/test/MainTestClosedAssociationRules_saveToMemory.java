 ...
 */
public class MainTestClosedAssociationRules_saveToMemory extends MainTestBase {
...
//		database.printDatabase();
		...
		ItemsetsWithTIDSBitset patterns = algo.runAlgorithm(null, database, minsupp, true, 10000);
		algo.printStats();

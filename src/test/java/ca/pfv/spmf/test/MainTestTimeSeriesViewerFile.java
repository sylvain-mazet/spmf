 ...
 */
public class MainTestTimeSeriesViewerFile extends MainTestBase {

	public static void main(String [] arg) throws IOException{
		
		// the input file
		String input = new MainTestBase().fileToPath("contextSAX_SplitNumber2.txt");    // contextSAX_SplitLength3  // 

 ...
 */
public class MainTestFHSAR extends MainTestBase {

	public static void main(String [] arg) throws IOException{

		MainTestBase main = new MainTestBase();

		String input = main.fileToPath("contextIGB.txt");  // the database
		String inputSAR = main.fileToPath("sar.txt");  // the sensitive association rules that we want to hide

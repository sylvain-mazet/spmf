 ...
 * @author Ting Li, 2016
 */
public class MainTestHAUIMMAU_saveToFile extends MainTestBase {
	
	public static void main(String [] args) throws IOException{
		MainTestBase main = new MainTestBase();
		String input = main.fileToPath("contextHAUIMMAU.txt");
		String minutilityPath = main.fileToPath("MAU_Utility.txt");

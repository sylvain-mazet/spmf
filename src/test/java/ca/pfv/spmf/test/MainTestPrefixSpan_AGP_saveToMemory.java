 ...
 * @author agomariz
 */
public class MainTestPrefixSpan_AGP_saveToMemory extends MainTestBase {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //sequenceDatabase.loadFile(new MainTestBase().fileToPath("salidaFormateadaCodificadaSinIDs.txt"), support);

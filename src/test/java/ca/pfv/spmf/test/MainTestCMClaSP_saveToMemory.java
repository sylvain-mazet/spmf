 ...
 * @author agomariz
 */
public class MainTestCMClaSP_saveToMemory extends MainTestBase {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //double relativeSupport = sequenceDatabase.loadFile(new MainTestBase().fileToPath("contextClaSP.txt"), support);

 ...
 */
public class MainTestHUI_LIST_INS extends MainTestBase {
	...
	public static void main(String[] arg) throws IOException {
		...
		String input1 = main.fileToPath("DB_UtilityIncremental1.txt");
		...
		String input2 = main.fileToPath("DB_UtilityIncremental2.txt");

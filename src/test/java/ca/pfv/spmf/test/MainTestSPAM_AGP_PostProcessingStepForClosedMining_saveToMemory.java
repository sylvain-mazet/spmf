 ...
 * @author agomariz
 */
public class MainTestSPAM_AGP_PostProcessingStepForClosedMining_saveToMemory extends MainTestBase {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //double relativeSupport = sequenceDatabase.loadFile(new MainTestBase().fileToPath("ExampleClaSP.txt"), support);
        double relativeSupport = sequenceDatabase.loadFile(new MainTestBase().fileToPath("contextPrefixSpan.txt"), support);
        //double relativeSupport = sequenceDatabase.loadFile(new MainTestBase().fileToPath("gazelle.txt"), support);

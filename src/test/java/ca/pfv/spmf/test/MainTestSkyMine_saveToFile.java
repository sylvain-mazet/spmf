 ...
 * */
public class MainTestSkyMine_saveToFile extends MainTestBase {
	...
	public static void main(String args[]) throws IOException {
		...
		// Input file paths
		String transactionFile = main.fileToPath("SkyMineTransaction.txt");
		String utilityTableFile = main.fileToPath("SkyMineItemUtilities.txt");

 ...
 */
public class MainTestInstancesViewer extends MainTestBase {

	public static void main(String [] arg) throws IOException{
		
		// the input file
//		String input = new MainTestBase().fileToPath("inputDBScan2.txt"); 
		String input = new MainTestBase().fileToPath("configKMeans.txt");   

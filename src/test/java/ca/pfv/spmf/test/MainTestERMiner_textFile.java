 ...
 */
public class MainTestERMiner_textFile extends MainTestBase {
...
//		 Charset charset = Charset.forName("UTF-8");
		...
		Map<Integer, String> mapping = converter.convertTEXTandReturnMap(
				new MainTestBase().fileToPath("example2.text"), "example2_converted.txt", Integer.MAX_VALUE, charset);

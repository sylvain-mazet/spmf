 ...
 */
public class MainTestTopKClassRules extends MainTestBase {

	public static void main(String [] arg) throws Exception{
		// Load database into memory
		Database database = new Database(); 
		database.loadFile(new MainTestBase().fileToPath("contextIGB.txt")); 
		
		int k = 7; 
		double minConf = 0.8; //
		
		// the item to be used as consequent for generating rules
		int[] itemToBeUsedAsConsequent = new int[]{1,2,3,4,5};
...
//		// Set this parameter to true to show the transaction identifiers
//		// for each pattern found.
//		algo.setOutputTransactionIdentifiers(true);

 ...
 */
public class MainTestSecondOrderDifferencingFileToFile extends MainTestBase {

	public static void main(String [] arg) throws IOException{
		
		// the input file
		String input = new MainTestBase().fileToPath("contextMovingAverage.txt");  
		// the output file
	...
	public String fileToPath(String filename) throws UnsupportedEncodingException{
		URL url = MainTestSecondOrderDifferencingFileToFile.class.getResource(filename);

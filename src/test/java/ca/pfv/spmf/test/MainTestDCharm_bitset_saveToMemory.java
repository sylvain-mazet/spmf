 ...
 */
public class MainTestDCharm_bitset_saveToMemory extends MainTestBase {

	public static void main(String [] arg) throws IOException{
		// Loading the binary context
		TransactionDatabase database = new TransactionDatabase();
		try {
			database.loadFile(new MainTestBase().fileToPath("contextPasquier99.txt"));
...
//		context.printContext();
		...
		ItemsetsWithTIDSBitset patterns = algo.runAlgorithm(null, database, 0.4, true, 10000);

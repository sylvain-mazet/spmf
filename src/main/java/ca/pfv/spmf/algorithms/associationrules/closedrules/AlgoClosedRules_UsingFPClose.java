...
public class AlgoClosedRules_UsingFPClose extends AlgoAgrawalFaster94{
	 ...
	 */
	public AssocRules runAlgorithm(FrequentPatternsResults patterns, String output, int databaseSize,
		...
		this.minlift = 0;
		this.cfiTree = (CFITree)patterns.getFITree();
		usingLift = false;
		
		// start the algorithm
		return runAlgorithm(patterns.getItemsets(), output, databaseSize);
	}
	 ...
	 * @throws IOException exception if error writing to the output file
	 */
	public AssocRules runAlgorithm(FrequentPatternsResults fpGrowthResults, String output, int databaseSize,
								   double minconf, double minlift) throws IOException {
		// save the parameters
		this.minconf = minconf;
		this.cfiTree = (CFITree) fpGrowthResults.getFITree();
		usingLift = true;
		
		// start the algorithm
		return runAlgorithm(fpGrowthResults.getItemsets(), output, databaseSize);
	}

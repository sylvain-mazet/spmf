...
public class AlgoFPClose {
	...
	public Itemsets runAlgorithm(String input, String output, double minsupp) throws FileNotFoundException, IOException {
		...
		return bottomHalf(tree, transactionCount,originalMapSupport);
	}

	public Itemsets bottomHalf(FPTree tree, int transactionCount, Map<Integer,Integer> originalMapSupport) throws IOException {

		this.originalMapSupport = originalMapSupport;

 ...
 */
public class DescriptionAlgoClosedClassAssociationRulesFPClose extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoClosedClassAssociationRulesFPClose(){
	}

	@Override
	public String getName() {
		return "Closed_class_association_rules(using_fpclose)";
	}
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		AlgoClosedClassRules_UsingFPClose algoRule = new AlgoClosedClassRules_UsingFPClose();
		algoRule.setMaxAntecedentLength(maxAntecedentLength);
		algoRule.runAlgorithm(patterns, outputFile, database.size(), minconf, algo.cfiTree, requiredItems);
		algoRule.printStats();
	}

...
/**
 * This class describes the SEQDIM algorithm parameters when applied with BIDE and AprioriClose. 
 * It is designed to be used by the graphical and command line interface.
 * 
 * @see AlgoSeqDim
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoSeqDIMBideAprioriClose extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoSeqDIMBideAprioriClose(){
	}

	@Override
	public String getName() {
		return "SeqDim_(BIDE+AprioriClose)";
	}
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		ca.pfv.spmf.algorithms.sequentialpatterns.fournier2008_seqdim.AlgoBIDEPlus bideplus = new ca.pfv.spmf.algorithms.sequentialpatterns.fournier2008_seqdim.AlgoBIDEPlus(
				minsup);
		algoSeqDim.setOutputSequenceIdentifiers(outputSeqIdentifiers);

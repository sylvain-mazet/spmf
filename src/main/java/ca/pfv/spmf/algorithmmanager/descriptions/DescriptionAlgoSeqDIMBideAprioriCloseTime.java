...
/**
 * This class describes the SEQDIM algorithm parameters when applied with BIDE, AprioriClose, and time constraints. 
 * It is designed to be used by the graphical and command line interface.
 * 
 * @see AlgoSeqDim
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoSeqDIMBideAprioriCloseTime extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoSeqDIMBideAprioriCloseTime(){
	}

	@Override
	public String getName() {
		return "SeqDim_(BIDE+AprioriClose)+time";
	}
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		algoSeqDim2.setOutputSequenceIdentifiers(outputSeqIdentifiers);

...
public class DescriptionAlgoTopKRules extends DescriptionOfAlgorithm {
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		if (parameters.length >=5 && "".equals(parameters[4]) == false) {
			outputTransactionIdentifiers = getParamAsBoolean(parameters[4]);
		}
	...
	public DescriptionOfParameter[] getParametersDescription() {
		...
		parameters[4] = new DescriptionOfParameter("Show transaction ids?", "(default: false)", Boolean.class, true);
		return parameters;
	}

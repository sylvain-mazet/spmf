...
public class DescriptionAlgoTNS extends DescriptionOfAlgorithm {
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		if (parameters.length >=6 && "".equals(parameters[6]) == false) {
			outputSequenceIdentifiers = getParamAsBoolean(parameters[6]);
		}
		algo.setOutputSequenceIdentifiers(outputSequenceIdentifiers);

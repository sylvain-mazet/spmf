...
public class DescriptionAlgoTNR extends DescriptionOfAlgorithm {
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		boolean outputTransactionIdentifiers = false;
		if (parameters.length >=6 && "".equals(parameters[5]) == false) {
			outputTransactionIdentifiers = getParamAsBoolean(parameters[5]);
		}
		algo.setOutputTransactionIdentifiers(outputTransactionIdentifiers);
	...
	public DescriptionOfParameter[] getParametersDescription() {
		...
		parameters[5] = new DescriptionOfParameter("Show transaction ids?", "(default: false)", Boolean.class, true);
		return parameters;
	}
